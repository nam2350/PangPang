...
namespace SqlCipher4Unity3D
{
    ...
    public class SQLiteConnection : IDisposable
    {
        ...
        public int Execute(string query, params object[] args)
        {
            ...
            if (this.TimeExecution)
            {
                ...
                Debug.Log(string.Format("Finished in {0} ms ({1:0.0} s total)", _sw.ElapsedMilliseconds,
    ...
    public class SQLiteCommand
    {
        ...
        {
            if (_conn.Trace) Debug.Log("Executing: " + this);
        ...
        {
            if (_conn.Trace) Debug.Log("Executing Query: " + this);
    ...
    public class PreparedSqlLiteInsertCommand : IDisposable
    {
        ...
        {
            if (this.Connection.Trace) Debug.Log("Executing: " + this.CommandText);
